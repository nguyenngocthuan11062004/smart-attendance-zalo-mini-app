...
\begin{enumerate}[leftmargin=1.5em]
  ...
  \item Thiết kế cơ chế xác minh ngang hàng (peer-to-peer) yêu cầu mỗi sinh viên tự
  quét mã xác nhận của ít nhất một sinh viên xung quanh (chỉ lượt tự quét mới được tính), nhằm chống điểm danh từ xa.
