...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \textbf{Xác minh ngang hàng.} Cơ chế trao đổi mã giữa các sinh viên (tối thiểu ba
  lượt) đã tạo ra bằng chứng về sự hiện diện vật lý, chống điểm danh từ xa.
