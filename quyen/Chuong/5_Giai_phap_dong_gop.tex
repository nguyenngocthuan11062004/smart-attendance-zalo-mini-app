...
viên tự quét mã QR của ít nhất một bạn xung quanh (chỉ lượt tự quét mới được tính); việc xác minh chéo này tạo ra một
\textbf{bằng chứng về sự hiện diện vật lý} mà một yếu tố đơn lẻ (mã hay khuôn mặt) khó tạo ra
được --- rất khó để tự quét được mã của một bạn đang có mặt trong phòng nếu bản thân không thực sự có mặt. Bổ trợ
