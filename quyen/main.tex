...
\makenoidxglossaries % [THÊM] bắt buộc để \printnoidxglossaries in được danh mục từ viết tắt
\usepackage{setspace}
\usepackage{parskip}
...
% ===================================================
\usepackage{hyperref}
\hypersetup{colorlinks=true, linkcolor=black, citecolor=black, urlcolor=black, linktoc=all, bookmarksnumbered=true} %
...
\subfile{Chuong/Ghi_chu_AI.tex} % Trang ghi chú AI = trang La Mã đầu (i), ngay trước Mục lục
\renewcommand*\contentsname{MỤC LỤC}

\titlecontents{chapter}
    [0.0cm]             % left margin
    {\bfseries\vspace{0.3cm}}                  % above code
    {{\bfseries CHƯƠNG \thecontentslabel.\ }}  % [SỬA] bỏ khoảng trắng thừa sau \scshape làm 'CHƯƠNG' bị thụt vào
    % numbered format
    {}         % unnumbered format
