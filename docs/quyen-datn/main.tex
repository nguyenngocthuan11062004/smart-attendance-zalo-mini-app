...
\usepackage{tabularx} % Bảng tự co giãn chiều rộng (cột X)
...
\def \TITLE{Xây dựng ứng dụng điểm danh thông minh Zimo Checkin trên nền tảng Zalo Mini App}
\def \AUTHOR{NGUYỄN NGỌC THUẬN}
...
\input{Tu_viet_tat} % Danh mục thuật ngữ và từ viết tắt (bảng thủ công)
